...
class StoryManager:
    ...
    async def process_story_message(self, message: discord.Message):
        ...
        async with SafeTyping(message.channel):
            try:
                ...
                story_gm_model_instance = ModelManager.init_model(story_gm_model_name)
                ...
                if gm_plan.action_type == "NARRATE":
                    ...
                    if not gm_plan.dialogue_context:
                        ...
                        for dialogue_ctx in gm_plan.dialogue_context:
                            ...
                            story_character_model_instance = ModelManager.init_model(story_character_model_name)
    ...
    async def _generate_and_save_summary(self, story_instance: StoryInstance):
        ...
        try:
            ...
            story_summary_model_instance = ModelManager.init_model(story_summary_model_name)
    ...
    async def _generate_and_save_outline(self, story_instance: StoryInstance):
        ...
        try:
            ...
            story_outline_model_instance = ModelManager.init_model(story_outline_model_name)
